...
% --------------------- mip-NeRF ---------------------
\section{Mip-NeRF: A Multiscale Representation for Anti-Aliasing Neural Radiance Fields} \label{sec:mipnerf}
...
% --------------------- mip-NeRF 360 ---------------------
\section{Mip-NeRF 360: Unbounded Anti-Aliased Neural Radiance Fields} \label{sec:mipnerf360}
...
\section{Block NeRF: Scalable Large Scene Neural View Synthesis}
...
% --------------------- Instant-ngp ---------------------
\section{Instant-ngp: Instant Neural Graphics Primitives with a Multiresolution Hash Encoding} \label{sec:instant-ngp}
